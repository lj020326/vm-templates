...
![vm-template-build-pipelines](./img/vm-template-build-pipelines.drawio.svg)
...
Detailed information for the [template build configuration parameters and options can be found here](./configuration.md).
...
![Jenkins - Configure shared Pipeline Automation Library](./img/screenshots/packer-templates-00-pipeline-library.png)


### Site Root folder

A root folder for the packer-templates environment can be setup similar to the following.
![Site Root](./img/screenshots/packer-templates-0-toplevel.png)

### VM Packer Template OS folders

Then setup folders for each VM OS defined as follows.
![Site Environments](./img/screenshots/packer-templates-1a-os.png)


### VM Packer Template OS Version folders

Then setup folders for each VM OS Version defined as follows.
![Site Environments](./img/screenshots/packer-templates-1a-os-versions.png)
![Site Environments](./img/screenshots/packer-templates-1a-os-version-builds.png)
...
![Build Template Pipeline Folders](./img/screenshots/packer-templates-1a-template-build-wrapper.png)

See the job console for the VM packer template build pipeline output.
![Job Console Output](./img/screenshots/packer-templates-1a-template-build-output.png)

The detailed [pipeline job console output](./jenkins-consoleText-packer-build-ubuntu-log.md).
...
![Job Definition](./img/screenshots/packer-templates-2a-run-all-builds-config.png)
...
![Job Console Output](./img/screenshots/packer-templates-2b-run-all-builds-output.png)
