...
# ref: https://github.com/vmware-samples/packer-examples-for-vsphere/blob/develop/builds/linux/debian/12/data/ks.pkrtpl.hcl
...
# Add build User SSH authorized public key
