...
#  BUILD_CONFIG=${PROJECT_DIR}/templates/${VM_DIST}/build-config.json
  ...
  PACKER_CMD_ARRAY+=("-var-file=common-vars.json")
  PACKER_CMD_ARRAY+=("-var-file=${VM_DIST_DIR}/distribution-vars.json")
  PACKER_CMD_ARRAY+=("-var-file=${VM_DIST_VERSION_DIR}/server/box_info.json")
  PACKER_CMD_ARRAY+=("-var-file=${VM_DIST_VERSION_DIR}/server/template.json")
