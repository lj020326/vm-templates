...
locals {
  ...
  // ref: https://github.com/jetbrains-infra/packer-builder-vsphere/issues/276#issuecomment-1135260884
  data_source_command = var.common_data_source == "http" ? "inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/kickstart.cfg" : "inst.ks=hd:/dev/sr1:/kickstart.cfg"
