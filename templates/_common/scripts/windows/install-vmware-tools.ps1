...
# source: https://github.com/vmware-samples/packer-examples-for-vsphere/blob/main/scripts/windows/windows-vmtools.ps1
...
if (-not $Running) {
  ...
  Write-Output "Reinstalling VMware Tools..."
  Start-Process "setup64.exe" -ArgumentList '/s /v "/qb REBOOT=R"' -Wait
