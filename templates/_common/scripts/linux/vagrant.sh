...
if [ -f /etc/vyos_build ]; then
    ...
    PUBLIC_KEY=$(curl -fsSL -A curl 'https://raw.githubusercontent.com/lj020326/vagrant/main/keys/vagrant.pub')
    ...
    sudo sh -c "curl -L https://raw.github.com/lj020326/vagrant/master/keys/vagrant.pub -o /home/vagrant/.ssh/authorized_keys"
