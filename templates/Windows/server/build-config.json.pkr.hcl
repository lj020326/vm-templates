...
source "vsphere-iso" "Windows" {
  ...
  cd_files        = ["_common/scripts/${var.vm_guest_os_family}/"]
...
build {
  ...
  provisioner "powershell" {
    ...
    environment_vars  = ["BUILD_USERNAME=${var.build_username}", "BUILD_PASSWORD=${var.build_password}", "BUILD_JOB_URL=${var.build_job_url}", "BUILD_JOB_ID=${var.build_job_id}", "BUILD_GIT_COMMIT_HASH=${var.build_git_commit_hash}", "CERT_URL_ENDPOINT=${var.cert_url_endpoint}"]
  ...
  provisioner "windows-update" {
    filters         = ["exclude:$_.Title -like '*VMware*'", "exclude:$_.Title -like '*Preview*'", "exclude:$_.Title -like '*Defender*'", "exclude:$_.InstallationBehavior.CanRequestUserInput", "include:$true"]
    pause_before    = "30s"
